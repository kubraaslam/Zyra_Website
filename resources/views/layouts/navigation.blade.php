<nav x-data="{ open: false, logoutModal: false  }"
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('logout')" @click.prevent="logoutModal = true">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
                </form>
            </div>
    ...
    <div x-show="logoutModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div @click.away="logoutModal = false" class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-80">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Confirm Logout</h2>
