<nav class="bg-gray-200 rounded-lg p-1 text-gray-600 text-xs font-semibold px-2 text-center 
            justify-center flex flex-wrap 
            md:flex-none md:flex-nowrap md:inline-flex md:space-x-4 md:text-sm">
